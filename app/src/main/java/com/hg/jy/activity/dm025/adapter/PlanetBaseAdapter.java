...
public class PlanetBaseAdapter extends BaseAdapter {
    ...
    private final List<Planet> mPlaneList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.act025_item_list, null);
            holder = new ViewHolder();
            holder.iv_icon = convertView.findViewById(R.id.dm025_iv_icon);
            holder.tv_name = convertView.findViewById(R.id.dm025_tv_name);
            holder.tv_desc = convertView.findViewById(R.id.dm025_tv_desc);
            // 将视图持有者保存到转换视图当中
