package com.hg.jy.activity.dm027.adapter;
...
public class LaunchSimpleAdapter extends PagerAdapter {
    ...
    public LaunchSimpleAdapter(Context context, int[] imageArray) {
        for (int i = 0; i < imageArray.length; i++) {
            View view = LayoutInflater.from(context).inflate(R.layout.act027_item_launch, null);
            ImageView iv_launch = view.findViewById(R.id.dm027_iv_launch);
            RadioGroup rg_indicate = view.findViewById(R.id.dm027_rg_indicate);
            Button btn_start = view.findViewById(R.id.dm027_btn_start);
